...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{
			Name:   "commit.prevrefspec",
			Usage:  "git prev commit ref spec",
		...
		cli.StringFlag{
			Name:   "commit.prev.link",
			Usage:  "previous build link",
...
func run(c *cli.Context) error {
	...
	plugin := Plugin{
		...
		Build: Build{
			...
			PrevRefSpec:    c.String("commit.prevrefspec"),
			...
			PrevCommitLink: c.String("commit.prev.link"),
